...
import './sidebar.css';
import { MdHome, MdReport, MdLocationOn, MdConnectWithoutContact, MdDashboard, MdSettings, MdContactPhone, MdPerson } from 'react-icons/md';
  ...
  return (
    <div className="sidebar">
      <nav className="menu">
        ...
        <a href="#" className="menu-item"><MdReport className="icon" /> Report SOS</a>
